...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jan 2019 pada 08.38
...
--
-- Dumping data untuk tabel `tb_grade`
--
...
--
-- Struktur dari tabel `tb_student_grade`
--
...
--
-- Dumping data untuk tabel `tb_student_grade`
--
...
INSERT INTO `tb_user` (`userID`, `user_name`, `user_email`, `user_password`, `user_level`, `user_status`, `network`, `created`, `modified`) VALUES
...
(2, 'Mukhlisin', 'mukliz@wolestech.com', '$2y$12$X6C2kroKsHdPvmMIhWnRO.7AVT44pAO1hSdeZ0OYueiD8mjN7nCPu', 1, 1, 'online', '2018-10-30 17:00:00', '2018-10-30 17:00:00');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_user_student`
--
...
--
-- Struktur dari tabel `tb_user_themes`
--
...
--
-- Dumping data untuk tabel `tb_user_themes`
--
...
--
-- Indeks untuk tabel `tb_grade`
--
ALTER TABLE `tb_grade`
  ADD PRIMARY KEY (`grade_id`);

--
-- Indeks untuk tabel `tb_parent`
--
...
--
-- Indeks untuk tabel `tb_student_grade`
--
...
--
-- Indeks untuk tabel `tb_user_student`
--
...
--
-- Indeks untuk tabel `tb_user_themes`
--
...
--
-- AUTO_INCREMENT untuk tabel `tb_grade`
--
ALTER TABLE `tb_grade`
  MODIFY `grade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tb_parent`
--
ALTER TABLE `tb_parent`
...
--
-- AUTO_INCREMENT untuk tabel `tb_student_grade`
--
ALTER TABLE `tb_student_grade`
...
--
-- AUTO_INCREMENT untuk tabel `tb_user_themes`
--
ALTER TABLE `tb_user_themes`
...
--
-- Ketidakleluasaan untuk tabel `tb_parent`
--
ALTER TABLE `tb_parent`
  ADD CONSTRAINT `fk_parent` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`userID`);
...
--
-- Ketidakleluasaan untuk tabel `tb_student_grade`
--
ALTER TABLE `tb_student_grade`
...
--
-- Ketidakleluasaan untuk tabel `tb_user_student`
--
ALTER TABLE `tb_user_student`
  ADD CONSTRAINT `fk_student_user` FOREIGN KEY (`student_id`) REFERENCES `tb_student` (`student_id`),
  ADD CONSTRAINT `fk_user` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`userID`);

--
-- Ketidakleluasaan untuk tabel `tb_user_themes`
--
ALTER TABLE `tb_user_themes`
  ADD CONSTRAINT `fk_user_themes` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`userID`);
COMMIT;
