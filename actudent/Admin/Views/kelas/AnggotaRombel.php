<!-- Modal -->
<div class="modal fade text-left" id="anggotaRombel" role="dialog" aria-labelledby="myModalLabel2"
            ...
            <div class="modal-body fix-height-500">
                <div class="row">
                    ...
                    <div class="col-5 scroll-overheight">
                        ...
                        class="btn btn-outline-danger add-margin-bottom-5px" @click="emptyGroup"> {{ lang.kelas_kosongkan_rombel }}</button>                                        
                                	...
                                	<tr v-for="(item, index) in data" :key="index" class="soft-dark">
                                		...
                                		<td>
                                			<button type="button" class="btn btn-icon btn-info mr-1"
                                				...
                                				:title="lang.kelas_add_member_title" @click="addGroupMember(item.student_id)">
