    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header {modalHeaderColor} white">
                <h4 class="modal-title white" id="myModalLabel2"><i class="la la-road2"></i> {{ lang.kelas_add_title }}</h4>
                ...
                <form class="form" id="formTambahKelas">
                    <div class="form-body">                        
                        <div class="form-group">
                            ...
                            <input class="form-control border-primary" type="text" :placeholder="makeSentenceCase(lang.kelas_label_nama)" name="grade_name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control border-primary" disabled type="text" :placeholder="lang.kelas_input_walikelas" v-model="selectedTeacher.name">
