<!-- Modal -->
<div class="modal fade text-left" id="editKelasModal" role="dialog" aria-labelledby="myModalLabel2"
aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary" @click="save(true, detailKelas.grade_id)"> {+ lang Admin.simpan +}</button>
            </div>
        </div>
    </div>
</div>
