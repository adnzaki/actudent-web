...
<body class="vertical-layout vertical-menu 2-columns {bodyColor} menu-expanded fixed-navbar" data-open="click"
					...
					<div class="col-12">
						<div class="card {cardColor}">
							<div class="card-header {cardColor}">
								<h4 class="card-title {cardTitleColor}">{+ lang AdminAbsensi.absensi_title +}</h4>
							...
							<div class="card-content collapse show" v-cloak>
								{+ include Actudent\Admin\Views\absensi\AbsensiAction +}
	...
	{endif}
	<script src="{assets}js/admin/ac-absensi.js" type="module"></script>
