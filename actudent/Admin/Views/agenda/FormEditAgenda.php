		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="col-12 text-right" v-if="helper.showSaveButton">
					<button type="button" class="btn btn-outline-danger" @click="toggleFormAction()"> {+ lang Admin.hapus
						+}</button>
				...
				<div class="col-12" v-if="helper.showDeleteButton">
					<div class="row">
						<div class="col-12">
							<p>{+ lang Admin.sure_to_delete +}</p>
						</div>
					</div>
					<div class="row">
						<div class="col-12 text-right">
							<button type="button" class="btn btn-outline-warning" @click="toggleFormAction('edit')"> {+ lang
								Admin.batal +}</button>
