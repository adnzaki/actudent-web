    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p v-else>
                    {+ lang AdminPesan.pesan_konfirmasi_hapus +} 
                    "{{ recipientName }}"?
                </p>
            </div>
            <div class="modal-footer" v-if="!helper.deleteProgress">
                ...
                <button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary" @click="deleteChat"> {+ lang Admin.hapus +}</button>
            </div>
        </div>
    </div>
