<div class="modal fade text-left" id="hapusModal" role="dialog" 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p v-if="helper.deleteProgress" class="text-center">
                    <strong>{+ lang AdminTimeline.timeline_delete_progress +}</strong>
                </p>
                <p v-else>{+ lang AdminTimeline.timeline_delete_confirm +}</p>
            </div>
            <div class="modal-footer" v-if="!helper.deleteProgress">
                ...
                <button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary" @click="removePost"> {+ lang Admin.hapus +}</button>
            </div>
        </div>
    </div>
