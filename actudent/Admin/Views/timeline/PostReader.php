						...
						<div class="row">
							<div class="col-12">
								<img class="img-thumbnail img-fluid" src="{appAssets}images/portfolio/width-1200/portfolio-1.jpg"
									alt="Timeline Image 1" v-if="timelineDetail.timeline_image === null">
								<img class="img-fluid" :src="helper.imageURL + timelineDetail.timeline_image"
									alt="timelineDetail.timeline_title" v-else>
								<p class="card-text">
