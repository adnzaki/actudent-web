<!-- Modal -->
<div class="modal fade text-left" id="editRuangModal" role="dialog" aria-labelledby="myModalLabel2"
aria-hidden="true">
    <!-- Error message -->
                ...
                <form class="form" id="formEditRuang">
                    <div class="form-body skin skin-square">                        
                        <div class="form-group">
                            ...
                            <input class="form-control border-primary" type="text" v-model="roomDetail.room_code"
                            minlength="3" maxlength ="6" :placeholder="lang.ruang_input_kode" name="room_code">
