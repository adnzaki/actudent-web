    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header {modalHeaderColor} white">
                <h4 class="modal-title white" id="myModalLabel2"><i class="la la-road2"></i> {{ lang.mapel_form_add_title }}</h4>
                ...
                <form class="form" id="formTambahMapel">
                    <div class="form-body skin skin-square">                        
                        <div class="form-group">
                            ...
                            <input class="form-control border-primary" type="text" minlength="3" maxlength ="6" :placeholder="lang.mapel_input_kode" name="lesson_code">
                            <form-error :msg="error.lesson_code" />
                        </div>
                        
                        <div class="form-group">
                            <label for="userinput6">{{ lang.mapel_nama }}</label>
                            <input class="form-control border-primary" type="text" :placeholder="lang.mapel_input_nama" name="lesson_name">
