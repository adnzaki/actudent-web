				...
				<form class="form" id="formEditPegawai">
					<div class="form-body">
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" v-model="staffDetail.staff_nik" minlength="10"
								maxlength="10" :placeholder="lang.staff_input_id" name="staff_nik">
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" v-model="staffDetail.staff_phone" minlength="11"
								maxlength="13" :placeholder="lang.staff_input_telp" name="staff_phone">
