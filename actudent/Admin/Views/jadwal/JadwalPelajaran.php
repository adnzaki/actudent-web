		...
		<div class="row">
			<div class="col-12">
				<div class="form-group">
					<button type="button" @click="close('jadwal')" class="btn btn-outline-warning"> {+ lang Admin.tutup +}
					</button>
				</div>
			</div>
		</div>
		<div class="table-responsive">
			<table class="table table-hover mb-0 cursor-pointer">
				...
				<tbody>
					<tr class="soft-dark">
						<td class="col-jadwal">
							<div class="text-left garis-pembatas" v-for="(item, index) in scheduleList.senin" :key="index">
								...
								<div :id="'accordion-senin-' + index" role="tabpanel" aria-labelledby="heading11"
									class="collapse text-left text-1rem">
						...
						<td class="col-jadwal">
							<div class="text-left garis-pembatas" v-for="(item, index) in scheduleList.selasa" :key="index">
								...
								<div :id="'accordion-selasa-' + index" role="tabpanel" aria-labelledby="heading11"
									class="collapse text-left text-1rem">
									{+ lang AdminJadwal.jadwal_durasi +}: {{ item.duration }}
									<span v-if="item.lesson_grade_id === null">{{ lang.jadwal_menit }}</span>
									<span v-else>{{ lang.jadwal_jam_pelajaran }}</span><br>
						...
						<td class="col-jadwal">
							<div class="text-left garis-pembatas" v-for="(item, index) in scheduleList.rabu" :key="index">
								...
								<div :id="'accordion-rabu-' + index" role="tabpanel" aria-labelledby="heading11"
									class="collapse text-left text-1rem">
									{+ lang AdminJadwal.jadwal_durasi +}: {{ item.duration }}
									<span v-if="item.lesson_grade_id === null">{{ lang.jadwal_menit }}</span>
									<span v-else>{{ lang.jadwal_jam_pelajaran }}</span><br>
						...
						<td class="col-jadwal">
							<div class="text-left garis-pembatas" v-for="(item, index) in scheduleList.kamis" :key="index">
								...
								<div :id="'accordion-kamis-' + index" role="tabpanel" aria-labelledby="heading11"
									class="collapse text-left text-1rem">
									{+ lang AdminJadwal.jadwal_durasi +}: {{ item.duration }}
									<span v-if="item.lesson_grade_id === null">{{ lang.jadwal_menit }}</span>
									<span v-else>{{ lang.jadwal_jam_pelajaran }}</span><br>
						...
						<td class="col-jadwal">
							<div class="text-left garis-pembatas" v-for="(item, index) in scheduleList.jumat" :key="index">
								...
								<div :id="'accordion-jumat-' + index" role="tabpanel" aria-labelledby="heading11"
									class="collapse text-left text-1rem">
									{+ lang AdminJadwal.jadwal_durasi +}: {{ item.duration }}
									<span v-if="item.lesson_grade_id === null">{{ lang.jadwal_menit }}</span>
									<span v-else>{{ lang.jadwal_jam_pelajaran }}</span><br>
						...
						<td class="col-jadwal">
							<div class="text-left garis-pembatas" v-for="(item, index) in scheduleList.sabtu" :key="index">
								...
								<div :id="'accordion-sabtu-' + index" role="tabpanel" aria-labelledby="heading11"
									class="collapse text-left text-1rem">
									{+ lang AdminJadwal.jadwal_durasi +}: {{ item.duration }}
									<span v-if="item.lesson_grade_id === null">{{ lang.jadwal_menit }}</span>
									<span v-else>{{ lang.jadwal_jam_pelajaran }}</span><br>
