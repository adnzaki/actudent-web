    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="formJadwal">
                    <div class="form-body">
                        ...
                        <div id="daftar-mapel" v-if="!scheduleManager.showInput">
                            ...
                            v-else v-for="(item, index) in scheduleManager.lessonsInput" :key="index">
                ...
                <button type="button" class="btn btn-outline-success center-btn full-circle" 
                    @click="closeInputJadwal" v-if="scheduleManager.showInput">
                    <span><i class="la la-check"></i></span>
                </button>
                <button type="button" class="btn btn-outline-info center-btn full-circle" 
                     @click="showInputJadwal" v-else>
                    <span><i class="la la-plus"></i></span>
                </button>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal"> {+ lang Admin.batal +}</button>
                <button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary" @click="saveJadwal"> {+ lang Admin.simpan +}</button>
            </div>
        </div>
    </div>
</div>
