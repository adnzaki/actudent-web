	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header {modalHeaderColor} white">
				<h4 class="modal-title white" id="myModalLabel2"><i class="la la-road2"></i> {{ lang.jadwal_edit_title }}</h4>
				...
				<form class="form" id="formEditMapel">
					<div class="form-body">
						<div class="form-group">
							...
							<div class="row">
								<div class="col-12">
									<select class="select2-mapel-terpilih" style="width: 100%;" id="mapel-terpilih" name="lesson_id">
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" disabled type="text"
								:placeholder="lang.jadwal_label_pilih_guru" v-model="selectedTeacher.name">
			...
			<div class="modal-footer">
				...
				<button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary"
					@click="saveMapel(true)"> {+ lang Admin.simpan +}</button>
			</div>
		</div>
	</div>
</div>
