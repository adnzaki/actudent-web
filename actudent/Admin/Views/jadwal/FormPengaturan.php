<!-- Modal -->
<div class="modal fade text-left" id="pengaturanModal" role="dialog" aria-labelledby="myModalLabel2"
aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header {modalHeaderColor} white">
                <h4 class="modal-title white" id="myModalLabel2"><i class="la la-road2"></i> {+ lang Admin.menu_pengaturan +}</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary" @click="savePengaturan"> {+ lang Admin.simpan +}</button>
            </div>
        </div>
    </div>
</div>
