<!-- Modal -->
<div class="modal fade text-left" id="editNilaiModal" role="dialog" aria-labelledby="myModalLabel2"
aria-hidden="true">
    <!-- Error message -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="formEditNilai">
                    <div class="form-body skin skin-square">                        
                        <div class="form-group">
                            <label for="userinput5">{{ lang.nilai_label_kategori }}</label>
                            <select class="select2 form-control mb-10" id="editTipe" style="width: 100%;" name="score_category">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control border-primary" type="text" v-model="scoreDetail.score_description"
                            :placeholder="lang.nilai_input_deskripsi" name="score_description">
            ...
            <div class="modal-footer">
                ...
                <button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary" @click="save(true, scoreDetail.score_id)"> {+ lang Admin.simpan +}</button>
            </div>
        </div>
    </div>
</div>
