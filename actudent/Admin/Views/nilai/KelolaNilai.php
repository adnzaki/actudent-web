    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <table class="table table-hover mb-0 cursor-pointer">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in studentList" :key="index" class="soft-dark">
                                ...
                                <td>
                                    <input class="form-control border-primary lineless-input" type="text" v-model="item.score" @keyup="forceFloat(item.score)">
                                </td>
            ...
            <div class="modal-footer">
                ...
                <button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary" @click="saveScores"> {+ lang Admin.simpan +}</button>
            </div>
        </div>
    </div>
</div>
