<!-- Modal -->
<div class="modal fade text-left" id="tambahNilaiModal" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true"
	v-if="helper.daftarNilai">
	<!-- Error message -->
				...
				<form class="form" id="formTambahNilai">
					<div class="form-body skin skin-square">
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" :placeholder="lang.nilai_input_deskripsi"
