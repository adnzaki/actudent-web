			...
			<div class="form-group">
				<div class="btn-group mr-1 mb-1">
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item action-list" @click="multiPresence" href="javascript:void(0)">{+ lang
	...
	<div class="row" v-if="guru.helper.showJadwal">
		<div class="col-12 col-sm-6 col-lg-4 mb-10">
			<div class="input-group">
				<input type='text' name="scheduleDate" class="form-control border-primary pickadate-selectors pickadate" />
		...
		<div class="col-12 col-sm-4 mb-10" v-if="guru.helper.showJadwal">
			<div class="form-group">
				<button type="button" class="btn btn-outline-danger" @click="showArchive" data-toggle="modal">{+ lang
