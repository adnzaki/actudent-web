              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  ...
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span>{+ lang Admin.silakan_login +}</span>
                  </h6>
                </div>
                  ...
                  <div class="card-body">
                    <form class="form-horizontal form-simple" id="form-login" novalidate>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6 col-12 text-center text-md-right"><a href="recover-password.html" class="card-link">{+ lang Admin.lupa_password +}</a></div>
                      </div>
                      <p v-bind:class="msgClass" v-if="showMsg">{{ msg }}</p>
                      <button type="button" @click="validasi" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> {+ lang Admin.login +}</button>
                    </form>
                  </div>
                </div>
                <div class="card-footer">
                  <div class="">
                    <p class="float-sm-left text-center m-0"><a href="recover-password.html" class="card-link">{+ lang Admin.pulihkan_password +}</a></p>
                    <p class="float-sm-right text-center m-0">{+ lang Admin.belum_daftar +} <a href="register-simple.html" class="card-link">{+ lang Admin.daftar_disini +}</a></p>
                  </div>
                </div>
              </div>
            </div>
