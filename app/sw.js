if (!self.define) {
  ...
  self.define = (i, n) => {
    ...
    c[s] = Promise.all(i.map((e) => b[e] || o(e))).then((e) => (n(...e), f));
  };
}
  ...
  e.setCacheNameDetails({ prefix: "actudent-vite" }),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: "assets/ErrorNotFound.6769f176.js",
          revision: "6451c8cab34ea5b5590ca366392d7487",
        },
        {
        ...
        {
          url: "assets/global.d28b0357.js",
          revision: "49d381655f08228af36d5e2bab7efa19",
        },
        {
        ...
        {
          url: "assets/index.7cb16df7.js",
          revision: "72c844ed9f3639f2c1ad100ab6f38c4f",
        },
        {
          url: "assets/index.a686d83c.css",
          revision: "7525f0d760c71356227b9f1e819b381a",
        },
        {
        ...
        {
          url: "assets/Login.4cf4af07.js",
          revision: "4c21c514757b33b7db75a7cbdc6d1e67",
        },
        {
          url: "assets/MainLayout.ede9f193.js",
          revision: "062cf248e617f3534c5c3dbf6efd1df6",
        },
        {
          url: "assets/QBanner.4fb49340.js",
          revision: "f5be1eb9e763fd5e909f95d1eaecb632",
        },
        {
          url: "assets/QLayout.6b71a7b2.js",
          revision: "8c4945bc7323a7200d97e4248d41eb81",
        },
        {
          url: "assets/register-component.2e12d3ed.js",
          revision: "152cac9c042cd52dfde7c07d231f9af1",
        },
        {
        ...
        {
          url: "assets/SetupPage.d7630a8f.js",
          revision: "d9587f3774466df9b1184f0563b54784",
        },
        {
        ...
        { url: "index.html", revision: "f0f5ca505f2633584f552acdc513ce05" },
        {
