  ...
  <q-card class="my-card">
    <q-card-section>
      ...
      <div :class="['row', titleSpacing()]">
        <date-selector />
        <presence-selector class="q-mt-md" />
        <row-dropdown
          v-if="$q.screen.gt.sm"
          class="q-mt-md"
          root-class="col-12 col-md-2 q-pr-sm"
        />
        <search-box
          :label="$t('siabsen_cari_guru')"
...
export default {
  name: 'ManageMain',
  components: { DateSelector, StaffList, PresenceDetail, PresenceSelector },
  setup() {
    return {
      titleSpacing,
    }
