<template>
  <q-dialog
    no-backdrop-dismiss
    v-model="store.showPermitDetail"
    :maximized="maximizedDialog()"
  >
    <q-card class="q-pa-sm" :style="cardDialog()">
      <q-card-section class="row items-center q-pb-none">
        <div class="text-h6 text-capitalize">
          {{ $t('siabsen_permit_detail') }}
        </div>
        <q-space />
      ...
      <q-card-section class="scroll card-section">
        <q-form class="q-gutter-xs">
          ...
          <div class="row">
            <div class="col-12 col-sm-6 q-pr-xs q-mt-md q-mb-sm">
              <q-input
                outlined
                dense
                v-model="store.permitDetail.permit_starttime"
                readonly
              />
            </div>
            <div class="col-12 col-sm-6 q-pr-xs q-my-md">
              <q-input
                outlined
                dense
                v-model="store.permitDetail.permit_endtime"
                readonly
              />
            </div>
          </div>
          ...
          <q-input
            ...
            dense
            readonly
            v-model="store.permitDetail.permit_reason"
          />
          <q-btn
            target="_blank"
            style="width: 100%"
        ...
        >
          <q-list>
            <q-item
              clickable
              v-close-popup
              @click="setStatus('approved', store.permitDetail.permit_id)"
            >
              <q-item-section>
            ...
            <q-item
              clickable
              v-close-popup
              @click="setStatus('rejected', store.permitDetail.permit_id)"
            >
              <q-item-section>
