  ...
  <q-card class="my-card q-pb-sm q-mt-md">
    <q-card-section>
      ...
      <q-option-group
        ...
        type="radio"
        v-model="store.daily_journal_sign"
      />
      <q-card-actions align="left">
        <q-btn
          :label="$t('simpan')"
          :disable="store.disableButton"
          @click="store.save(store.daily_journal_sign, 'daily_journal_sign')"
          color="primary"
          padding="8px 20px"
        />
      </q-card-actions>
...
export default {
  setup() {
    ...
    onMounted(() => store.getSignSetting('daily_journal_sign'))
