    ...
    <q-card class="q-pa-sm" :style="cardDialog()">
      ...
      <q-card-section class="scroll card-section">
        <q-form class="q-gutter-xs">
          <q-input outlined :label="getLang.staff_input_id" minlength="10" maxlength="10" dense v-model="formData.staff_nik" />
          <error :label="error.staff_nik" />
          
          <q-input outlined :label="getLang.staff_label_nama" dense v-model="formData.staff_name" />
          <error :label="error.staff_name" />

          <q-input outlined :label="getLang.staff_label_telp" minlength="11" maxlength="13" dense v-model="formData.staff_phone" />
          ...
          <div class="row q-mb-md">
            <div class="col-6"><q-radio v-model="formData.staff_type" val="teacher" :label="getLang.staff_input_guru" /></div>
            <div class="col-6"><q-radio v-model="formData.staff_type" val="staff" label="Staff" /></div>
          </div>

          <q-input outlined :label="getLang.staff_label_jabatan" dense v-model="formData.staff_title" />
