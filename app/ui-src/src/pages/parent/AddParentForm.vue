  ...
  <q-dialog no-backdrop-dismiss v-model="$store.showAddForm" 
    ...
    <q-card class="q-pa-sm" :style="cardDialog()">
      <q-card-section class="row items-center q-pb-none">
        <div class="text-h6 text-capitalize">{{ $t('ortu_form_add_title') }}</div>
        <q-space />
      ...
      <q-card-section class="scroll card-section">
        <q-form class="q-gutter-xs">
          <q-input outlined :label="$t('ortu_kk')" minlength="16" maxlength="16" dense v-model="formData.parent_family_card" />
          <error :label="error.parent_family_card" />
          
          <q-input outlined :label="$t('ortu_label_ayah')" dense v-model="formData.parent_father_name">
          ...
          <q-input outlined :label="$t('ortu_label_ibu')" dense v-model="formData.parent_mother_name">
          ...
          <q-input outlined :label="$t('ortu_label_telp')" minlength="11" maxlength="13" dense v-model="formData.parent_phone_number" />
