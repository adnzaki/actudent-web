          ...
          <tr v-for="(item, index) in presenceList" :key="index">
            ...
            <td class="text-left mobile-hide">
              <q-btn-group v-if="presenceButtons">
                <q-btn color="accent" icon="done"><btn-tooltip :label="$t('absensi_hadir')" /></q-btn>
                <q-btn color="accent" icon="health_and_safety"><btn-tooltip :label="$t('absensi_sakit')" /></q-btn>
                <q-btn color="accent" icon="error_outline"><btn-tooltip :label="$t('absensi_izin')" /></q-btn>
                <q-btn color="accent" icon="not_interested"><btn-tooltip :label="$t('absensi_alfa')" /></q-btn>
              </q-btn-group>
              <p v-else>-</p>
            </td>
