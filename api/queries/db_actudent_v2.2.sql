...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2020 at 06:11 AM
...
(19, 7, 2, 4, 0, '2020-04-06 08:37:55', '2020-04-06 08:37:55'),
(20, 2, 2, 6, 0, '2020-04-06 08:38:15', '2020-04-06 08:45:21'),
(21, 8, 2, 5, 0, '2020-04-06 08:45:32', '2020-04-06 08:45:32');
...
INSERT INTO `tb_schedule` (`schedule_id`, `lessons_grade_id`, `schedule_semester`, `schedule_day`, `duration`, `schedule_start`, `schedule_end`) VALUES
(1, 11, 1, 'senin', 90, '07.00', '08.30'),
(2, 12, 1, 'senin', 45, '08.30', '09.15'),
(3, 12, 1, 'senin', 45, '09.35', '10.20'),
(4, 13, 1, 'senin', 90, '10.20', '11.50'),
(5, 19, 1, 'selasa', 90, '07.00', '08.30'),
(6, 20, 1, 'selasa', 45, '08.30', '09.15');
...
(1, 'Adnan Zaki', 'admin@wolestech.com', '$2y$10$4l1uN20KpNheU3EaSQkF6OuNPYjyBqvb3ePCHgXPAy/4tm95ROkZa', 1, 0, 'online', '2018-10-10 17:00:00', '2020-03-31 14:25:26'),
...
(4, 'Firhan Yudha P.', 'firhanyp@wolestech.com', '$2y$10$YjF6IhAqqyZXdRnWl1Shze/C7GDi3lQfjonU0RgLsfjlX0XUjTF4K', 2, 0, 'online', '2019-03-17 17:00:00', '2020-02-20 07:03:55'),
...
--
ALTER TABLE `tb_lessons_grade`
  MODIFY `lessons_grade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `tb_parent`
--
ALTER TABLE `tb_parent`
  MODIFY `parent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
