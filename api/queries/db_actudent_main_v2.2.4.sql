...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 07, 2022 at 05:56 PM
...
CREATE TABLE `tb_organization` (
  ...
  `db_version` varchar(10) NOT NULL DEFAULT '2.2.3',
  `created` timestamp NOT NULL DEFAULT current_timestamp(),
...
(1, 'SMK Negeri 11 Kota Bekasi', 'smkn11kotabekasi.actudent.com', 'https://api.smkn11kotabekasi.actudent.com/index.php/api/v1/', '2.2.3', '2019-01-30 07:35:58', '2022-03-07 16:44:53'),
(2, 'Actudent Demo', 'demo.actudent.com', 'https://api.demo.actudent.com/index.php/api/v1/', '2.2.3', '2020-06-30 08:16:04', '2022-03-07 16:44:53'),
(3, 'SMKN 999 Kota Bekasi', 'localhost', 'https://api.demo.actudent.com/index.php/api/v1/', '2.2.3', '2020-06-30 08:16:04', '2022-03-07 16:44:53');
...
--
ALTER TABLE `tb_notification`
  MODIFY `notif_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
