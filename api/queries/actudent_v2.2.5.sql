...
-- Dumping structure for table db_actudent.tb_agenda
...
-- Dumping data for table db_actudent.tb_agenda: ~34 rows (approximately)
...
-- Dumping structure for table db_actudent.tb_agenda_user
CREATE TABLE IF NOT EXISTS `tb_agenda_user` (
  ...
  `modified` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`agenda_id`),
  CONSTRAINT `fk_agenda` FOREIGN KEY (`agenda_id`) REFERENCES `tb_agenda` (`agenda_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table db_actudent.tb_agenda_user: ~9 rows (approximately)
/*!40000 ALTER TABLE `tb_agenda_user` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_agenda_user` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_chat
...
-- Dumping data for table db_actudent.tb_chat: ~8 rows (approximately)
/*!40000 ALTER TABLE `tb_chat` DISABLE KEYS */;
INSERT INTO `tb_chat` (`chat_id`, `chat_user_id`, `sender`, `content`, `read_status`, `created`) VALUES
	(1, 1, 1, 'selamat siang pak rizal', 1, '2020-12-23 11:48:29'),
	(2, 1, 53, 'siang pak zaki', 1, '2020-12-23 11:49:02'),
	(3, 1, 1, 'halo halo', 1, '2021-01-07 14:27:31'),
	(4, 1, 1, 'hai hai', 1, '2021-01-07 14:29:41'),
	(5, 1, 1, 'hai juga..', 1, '2021-01-13 12:07:57'),
	(6, 1, 1, 'eh itu kan saya sendiri', 1, '2021-01-13 12:08:03'),
	(7, 1, 53, 'apasih astaghfirullah..', 1, '2021-01-19 10:21:07'),
	(8, 1, 1, 'ngga', 0, '2021-02-07 17:10:59');
/*!40000 ALTER TABLE `tb_chat` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_chat_users
...
-- Dumping data for table db_actudent.tb_chat_users: ~1 rows (approximately)
/*!40000 ALTER TABLE `tb_chat_users` DISABLE KEYS */;
INSERT INTO `tb_chat_users` (`chat_user_id`, `participant_1`, `participant_2`, `created`) VALUES
	(1, '1', '53', '2020-12-23 11:48:29');
/*!40000 ALTER TABLE `tb_chat_users` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_grade
...
-- Dumping data for table db_actudent.tb_grade: ~5 rows (approximately)
...
INSERT INTO `tb_grade` (`grade_id`, `grade_name`, `period_start`, `period_end`, `teacher_id`, `grade_status`, `rombel_dapodik_id`, `deleted`, `created`, `modified`) VALUES
	(1, 'X TKJ 2', '2021', '2022', 2, 1, NULL, 1, '2019-03-29 12:51:07', '2021-12-19 00:02:27'),
	(2, 'X Grafika 1', '2021', '2022', 10, 1, NULL, 0, '2019-03-28 14:37:57', '2021-12-19 00:02:27'),
	(3, 'X TKJ 1', '2021', '2022', 1, 1, NULL, 0, '2019-03-29 12:54:53', '2021-12-19 00:02:27'),
	(6, 'X Animasi 1', '2021', '2022', 2, 1, NULL, 0, '2020-03-11 22:22:07', '2021-12-19 00:02:27'),
	(7, 'X TKJ 2', '2021', '2022', 4, 1, NULL, 1, '2020-04-03 21:02:17', '2021-12-19 00:02:27');
/*!40000 ALTER TABLE `tb_grade` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_homework
...
-- Dumping data for table db_actudent.tb_homework: ~21 rows (approximately)
...
INSERT INTO `tb_homework` (`journal_id`, `homework_title`, `homework_description`, `due_date`, `created`, `modified`) VALUES
	(40, 'Tugas Harian 1', 'Kerjakan tugas halaman sekian pada buku ini', '2020-07-08 23:46:36', '2020-07-01 06:46:36', '2020-07-01 06:46:36'),
	(47, 'Menjadi warga negara yang baik', 'Cobalah menjadi warga negara yang bijaksana, jangan ugal-ugalan', '2020-07-22 00:32:16', '2020-07-01 07:32:16', '2020-07-01 07:32:16'),
	(48, 'beli kertas plano', 'coba kalian cari tau berapa harga kertas plano sekarang', '2020-07-16 23:59:00', '2020-07-09 12:55:13', '2020-07-09 12:55:13'),
	(62, 'Nilai-nilai pancasila', 'menyebutkan 5 contoh sikap pelajar yang menggambarkan nilai-nilai pancasial', '2020-07-17 04:30:54', '2020-07-10 11:30:54', '2020-07-10 11:30:54'),
	(70, 'kalkulasi grafik', 'mengerjakn tugas lks halaman 28-29', '2020-07-18 02:24:23', '2020-07-11 09:24:23', '2020-07-11 09:24:23'),
	(77, 'Mempelajari hukum newton', 'coba itu', '2020-07-23 23:59:00', '2020-07-16 12:51:41', '2020-07-16 14:01:40'),
	(81, 'Tugas mengarang puisi', 'Coba buat', '2020-07-23 23:59:00', '2020-07-16 16:37:55', '2020-07-16 16:37:55'),
	(82, 'Menghitung harga kertas', 'Cobalah hitung harga kertas ya! ', '2020-08-01 23:59:00', '2020-07-27 13:42:39', '2020-07-27 13:42:39'),
	(84, 'Menanam toge', 'Coba praktekkan di rumah masing-masing', '2020-09-11 23:59:00', '2020-09-04 06:56:12', '2020-09-04 06:56:12'),
	(85, 'Membuat pesawat cerita masa kecil', 'Ceritakan dengan bahasa inggris yang baik dan benar ', '2020-09-11 23:59:00', '2020-09-04 06:59:14', '2020-09-04 06:59:14'),
	(92, 'melanjutkan tugas dari sekolah', 'coba buatlah cerpen yang oke', '2020-09-30 23:59:00', '2020-09-23 11:35:56', '2020-09-23 11:35:56'),
	(96, 'Kalkulasi Grafika Dasar', 'Mengerjakan LKS hal 34 - 37', '2020-11-04 05:36:49', '2020-10-28 12:36:37', '2020-10-28 12:36:49'),
	(97, 'Membuat gambar 2D', 'Silakan buat gambar 2D sederhana menggunakan Adobe illustrator', '2020-11-07 05:48:03', '2020-11-01 12:48:03', '2020-11-01 12:48:03'),
	(104, 'tata bahasa dirumah', 'belajar bicara bahasa inggris bersama mama papa', '2021-01-20 23:59:00', '2021-01-13 12:21:05', '2021-01-13 12:21:05'),
	(125, 'Membuat segitiga sama kaki', 'Coba kerjakan dengan kaki anda', '2022-02-21 23:59:00', '2022-02-21 09:23:32', '2022-02-21 09:23:32'),
	(126, 'membuat apa saja yang kau bisa', 'sama kaya judulnya', '2022-02-21 23:59:00', '2022-02-21 11:23:25', '2022-02-21 11:23:25'),
	(128, 'Membeli kertas plano', 'Membeli kertas plano', '2022-02-24 23:59:00', '2022-02-22 09:18:24', '2022-02-22 09:18:24'),
	(129, 'Mencari contoh makhluk hidup', 'Seperti hewan, tumbuhan, dll...', '2022-02-24 23:59:00', '2022-02-22 09:21:30', '2022-02-22 09:21:30'),
	(130, 'Input tugas rumah', 'uraian tugasnya..', '2022-02-24 23:59:00', '2022-02-22 09:26:24', '2022-02-22 09:26:24'),
	(131, 'Menulis karya puisi sendiri', 'Dikerjakan di rumah', '2022-02-24 23:59:00', '2022-02-22 12:19:36', '2022-02-22 12:19:36'),
	(132, 'Menulis karya puisi sendiri', 'Dikerjakan di rumah', '2022-02-24 23:59:00', '2022-02-22 12:20:19', '2022-02-22 12:20:19');
/*!40000 ALTER TABLE `tb_homework` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_journal
...
-- Dumping data for table db_actudent.tb_journal: ~99 rows (approximately)
/*!40000 ALTER TABLE `tb_journal` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_journal` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_lessons
...
-- Dumping data for table db_actudent.tb_lessons: ~16 rows (approximately)
...
INSERT INTO `tb_lessons` (`lesson_id`, `lesson_code`, `lesson_name`, `deleted`, `created`, `modified`) VALUES
	(1, 'MTK', 'Matematika', 0, '2020-03-21 19:44:18', '2020-03-21 19:44:18'),
	(2, 'BIND', 'Bahasa Indonesia', 0, '2020-03-21 19:44:18', '2020-03-21 19:44:18'),
	(3, 'BING', 'Bahasa Inggris', 0, '2020-03-21 19:44:18', '2020-03-21 19:44:18'),
	(4, 'PAI', 'Pendidikan Agama Islam', 0, '2020-03-21 19:44:18', '2020-03-21 19:44:18'),
	(5, 'PKN', 'Pendidikan Kewarganegaraan', 0, '2020-03-21 19:44:18', '2020-03-21 19:44:18'),
	(6, 'PJOK', 'Pendidikan Jasmani, Olahraga dan Kesehatan', 0, '2020-03-21 19:44:18', '2020-03-21 19:44:18'),
	(7, 'IPS', 'Ilmu Pengetahuan Sosial', 0, '2020-04-05 19:11:11', '2020-04-05 19:11:11'),
	(8, 'PLH', 'Pendidikan Lingkungan Hidup', 0, '2020-04-05 19:11:55', '2020-04-05 19:11:55'),
	(9, 'FSK', 'Fisika', 0, '2020-04-17 17:10:07', '2020-04-17 17:10:07'),
	(10, 'KMA', 'Kimia', 0, '2020-04-17 17:10:16', '2020-04-17 17:10:16'),
	(11, 'BIO', 'Biologi', 0, '2020-04-17 17:10:24', '2020-04-17 17:10:24'),
	(12, 'PRD', 'Pemrograman Dasar', 0, '2020-04-17 17:10:58', '2020-04-17 17:10:58'),
	(13, 'KGRF', 'Kalkulasi Grafika', 0, '2020-05-29 05:51:38', '2020-05-29 05:51:38'),
	(14, 'DGR', 'Desain Grafis', 0, '2020-05-29 05:51:50', '2020-05-29 05:51:50'),
	(15, 'IKOM', 'Instalasi Komputer', 0, '2020-07-09 12:42:05', '2020-07-09 12:42:05'),
	(16, 'PRG', 'Pemrograman Dasar', 1, '2020-07-09 12:43:19', '2021-01-13 12:09:24');
/*!40000 ALTER TABLE `tb_lessons` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_lessons_grade
...
-- Dumping data for table db_actudent.tb_lessons_grade: ~19 rows (approximately)
/*!40000 ALTER TABLE `tb_lessons_grade` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_lessons_grade` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_parent
...
-- Dumping data for table db_actudent.tb_parent: ~42 rows (approximately)
...
INSERT INTO `tb_parent` (`parent_id`, `user_id`, `parent_family_card`, `parent_father_name`, `parent_mother_name`, `parent_phone_number`, `deleted`, `created`, `modified`) VALUES
	(1, 14, '3273987984273984', 'Bambang Tri', 'Sintia', '080385048593', 1, '2020-02-08 12:04:31', '2020-02-10 09:59:52'),
	(2, 15, '3287398279873984', 'Sinto', 'Santi', '0879349895849', 1, '2020-02-08 12:06:12', '2020-02-10 09:59:32'),
	(3, 16, '3287879823749827', 'Rizky Nur Hidayat', 'Jihan Nur Kamila', '0894587839734', 1, '2020-02-10 09:54:50', '2020-02-10 09:59:53'),
	(4, 17, '3298738297498273', 'Bernard Siahaan', 'Juliana Zein', '0868785949388', 1, '2020-02-10 10:01:33', '2020-02-10 10:03:19'),
	(10, 23, '3276438945089802', 'Haryanto', 'Fatmawati', '0867276876786', 0, '2020-02-10 14:33:09', '2020-02-19 20:44:39'),
	(11, 24, '3275092039402859', 'Ahmad Ridho', 'Liana Saktiwanti', '087865368761', 0, '2020-02-10 14:34:15', '2020-02-10 14:34:15'),
	(12, 25, '3275099839457398', 'Fahruliansyah', 'Sheila Nur Majid', '0867587247827', 0, '2020-02-10 14:35:17', '2020-02-10 14:35:17'),
	(13, 26, '3276874874958794', 'Andreas Prasetyo', 'Intan Nur Hotimah', '0832894937857', 0, '2020-02-10 14:35:54', '2020-02-10 14:35:54'),
	(14, 27, '3271908329042839', 'Emet Nur Cholis', 'Amit Nur Badai', '0878745987326', 0, '2020-02-10 14:38:11', '2020-02-10 14:38:11'),
	(15, 28, '3283729873982749', 'Gledek Nurmantyo', 'Bredek Santini', '0824839048395', 0, '2020-02-10 15:10:10', '2020-02-10 15:10:10'),
	(16, 29, '2413432214135233', 'bambang', 'siti', '02125587341', 0, '2020-02-10 15:15:03', '2020-02-10 15:15:29'),
	(17, 30, '3287874289374983', 'Badut Siahaan', 'Didot Mantaulu', '085789739842', 0, '2020-02-10 15:16:45', '2020-02-10 15:16:45'),
	(18, 31, '3184613454254134', 'Katmo', 'Sri ', '0813813461134', 0, '2020-02-10 15:16:56', '2020-02-10 15:16:56'),
	(19, 32, '3290809284095894', 'Abdi Negara Sejati', 'Ibu Negara', '0839809458490', 0, '2020-02-10 15:17:14', '2020-02-20 11:24:14'),
	(20, 33, '3750936413456432', 'Yono', 'Maemunah', '0812064658643', 0, '2020-02-10 15:17:33', '2020-02-10 15:17:33'),
	(21, 34, '3297398274982378', 'Amran Kartakarun', 'Imrin Kirtikirin', '0857683278465', 0, '2020-02-10 15:17:53', '2020-02-10 15:17:53'),
	(22, 35, '3275120300505310', 'Jajang', 'Yati', '0856062315840', 0, '2020-02-10 15:18:10', '2020-02-10 15:18:10'),
	(23, 36, '3283972987895749', 'Sandrayono', 'Sandrayani', '0886509486904', 0, '2020-02-10 15:19:23', '2020-02-10 15:19:23'),
	(24, 37, '5475272753675201', 'Anto', 'Iis', '0287630563123', 0, '2020-02-10 15:19:31', '2020-02-10 15:19:31'),
	(25, 38, '6541435432165333', 'Asam Suryanto', 'Asyinah Said', '2504540757546', 0, '2020-02-10 15:20:15', '2020-07-09 12:33:28'),
	(26, 39, '3298038972983748', 'Mugiono Apriyani', 'Cici Parwito', '0894984590684', 0, '2020-02-10 15:31:25', '2020-02-10 15:34:27'),
	(27, 40, '9023908092859480', 'Jamet Brigidik', 'Linda Sukmawati', '0877998492384', 1, '2020-02-20 11:25:09', '2020-02-20 11:25:24'),
	(28, 41, '3276298739874982', 'Berry Sihalahua', 'Rinti Sumanti', '0878674638823', 0, '2020-03-10 14:32:22', '2020-03-10 14:32:22'),
	(29, 42, '3276983290485830', 'Abdul Jabbar', 'Siti Nurhasanah', '0878479832984', 0, '2020-03-10 14:34:54', '2020-03-10 14:34:54'),
	(30, 43, '3276732698472987', 'Riko Tantorini', 'Reina Suhanda', '08783874878', 0, '2020-03-11 20:09:01', '2020-03-11 20:09:01'),
	(31, 46, '3290892374892372', 'Baharudin Saifulloh', 'Ina Karlina', '0897983787863', 1, '2020-04-03 20:06:55', '2020-04-03 20:07:47'),
	(32, 51, '3282367468287467', 'Muhammad Azam Bin Bayan', 'Indri Sintiasari', '0878987367253', 0, '2020-07-09 12:36:01', '2020-07-09 12:36:01'),
	(33, 52, '3276827498459892', 'Kartono', 'Kartini', '0898737687634', 0, '2020-07-09 12:37:39', '2020-07-09 12:37:39'),
	(34, 55, '3275040529203046', 'Abdul Majid', 'Siti Fatimah', '089932108876', 0, '2021-05-17 11:29:42', '2021-05-17 11:29:42'),
	(35, 56, '3298798257489374', 'jsndfjsn', 'jnsjfdn', '0809839849899', 0, '2021-05-17 15:06:27', '2021-05-17 15:06:27'),
	(36, 57, '3289782734874878', 'Ibnu Kamil', 'Masitoh', '089898948293', 0, '2021-05-17 15:28:06', '2021-05-17 15:28:06'),
	(37, 58, '3298798347539898', 'Ahmad Hasan ', 'Rina Puspita', '083989489485', 0, '2021-05-17 15:30:35', '2021-05-17 15:30:35'),
	(38, 59, '3298792898394893', 'Ahmad Fajrul', 'Rina Rosinta', '083989482878', 0, '2021-05-17 15:31:31', '2021-05-17 15:31:31'),
	(39, 60, '3289798237482735', 'Roni Sianturi', 'Rima Nurmala', '089738979823', 0, '2021-05-17 17:28:06', '2021-05-17 17:28:06'),
	(40, 61, '3287928374897387', 'Adi Sumarno', 'Rini Sumarni', '08890389284', 0, '2021-05-17 17:44:07', '2021-05-17 17:44:07'),
	(41, 62, '3298782374834785', 'Hamdan Syakirin', 'Lusiana Fatinah', '089083984432', 0, '2021-05-17 17:48:17', '2021-05-17 17:48:17'),
	(42, 63, '3287923784787872', 'Hamdan Naimin', 'Mazidah', '098300983992', 0, '2021-05-17 17:57:22', '2021-05-17 17:57:22'),
	(43, 64, '3275978923490824', 'Syarif Romadhon', 'Syarifah Ramadhani', '088492898393', 0, '2021-05-17 19:56:31', '2021-05-17 19:56:31'),
	(44, 65, '3209809324037483', 'Izzatul Islam', 'Mariana Dista', '080894894893', 0, '2021-05-17 20:04:32', '2021-05-17 20:04:32'),
	(45, 66, '3298789237484375', 'Abdul Fattah', 'Rini Marini', '0839089384938', 0, '2021-05-17 20:05:20', '2021-05-17 20:05:20'),
	(46, 67, '3287983475834757', 'Himdin', 'Himdiniyih', '089038984989', 0, '2021-05-17 20:09:31', '2021-05-17 20:09:31'),
	(47, 68, '3297982374837583', 'Huntu', 'Hinti', '08039485948', 0, '2021-05-18 12:25:53', '2021-05-18 12:25:53');
/*!40000 ALTER TABLE `tb_parent` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_presence
...
-- Dumping data for table db_actudent.tb_presence: ~652 rows (approximately)
/*!40000 ALTER TABLE `tb_presence` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_presence` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_room
...
-- Dumping data for table db_actudent.tb_room: ~7 rows (approximately)
/*!40000 ALTER TABLE `tb_room` DISABLE KEYS */;
INSERT INTO `tb_room` (`room_id`, `room_name`, `room_code`, `deleted`, `created`, `modified`) VALUES
	(1, 'Ruang 113', 'R113', 0, '2020-04-23 22:11:56', '2020-04-23 22:11:56'),
	(2, 'Ruang 114', 'R114', 0, '2020-04-23 22:11:56', '2020-04-23 22:11:56'),
	(3, 'Ruang 098', 'R098', 0, '2020-05-29 05:41:27', '2020-05-29 05:43:49'),
	(4, 'Laboratorium Komputer 1', 'LAB01', 0, '2020-05-29 05:42:00', '2020-05-29 05:43:51'),
	(5, 'Ruang 100', 'R100', 0, '2020-05-29 05:45:14', '2020-05-29 05:45:14'),
	(6, 'Ruang 120', 'R120', 0, '2020-06-20 10:40:44', '2020-06-20 10:40:44'),
	(7, 'KELAS 10', 'R01', 0, '2020-06-20 10:41:50', '2020-06-20 10:41:50');
/*!40000 ALTER TABLE `tb_room` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_schedule
...
-- Dumping data for table db_actudent.tb_schedule: ~50 rows (approximately)
...
-- Dumping structure for table db_actudent.tb_schedule_settings
...
-- Dumping data for table db_actudent.tb_schedule_settings: ~2 rows (approximately)
/*!40000 ALTER TABLE `tb_schedule_settings` DISABLE KEYS */;
INSERT INTO `tb_schedule_settings` (`schedule_setting_id`, `setting_name`, `setting_value`) VALUES
	(1, 'lesson_hour', '40'),
	(2, 'start_time', '7.25');
/*!40000 ALTER TABLE `tb_schedule_settings` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_school
...
-- Dumping data for table db_actudent.tb_school: ~1 rows (approximately)
...
-- Dumping data for table db_actudent.tb_score: ~5 rows (approximately)
...
INSERT INTO `tb_score` (`score_id`, `lessons_grade_id`, `score_type`, `score_category`, `score_description`, `deleted`, `created`, `modified`) VALUES
	(1, 34, 'Teori', 'Tugas', 'Menjadi warga negara yang baik', 0, '2020-09-18 15:40:31', '2020-09-18 15:40:31'),
	(2, 35, 'Praktik', 'Tugas', 'Latihan memanjat tebing', 0, '2020-09-18 15:50:32', '2020-09-18 15:50:32'),
	(3, 42, 'Teori', 'Tugas', 'Menghitung harga kertas plano', 0, '2020-09-18 15:52:50', '2020-09-18 15:52:50'),
	(4, 42, 'Teori', 'UH', 'Ini ulangan tersulit', 0, '2020-09-18 15:55:02', '2020-09-18 15:55:02'),
	(5, 34, 'Teori', 'Tugas', 'Tes mengingat kenangan', 0, '2020-09-18 16:51:02', '2020-09-18 16:51:02');
/*!40000 ALTER TABLE `tb_score` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_score_student
...
-- Dumping data for table db_actudent.tb_score_student: ~13 rows (approximately)
/*!40000 ALTER TABLE `tb_score_student` DISABLE KEYS */;
INSERT INTO `tb_score_student` (`score_id`, `student_id`, `score`, `score_note`, `created`, `modified`) VALUES
	(1, 1, 85.00, 'sudah bagus sekali ini', '2020-09-18 15:41:05', '2020-09-18 15:41:05'),
	(1, 6, 80.00, 'kalah oleh rekannya', '2020-09-18 15:41:05', '2020-09-18 15:41:05'),
	(2, 1, 95.00, 'pertahankan prestasimu', '2020-09-18 15:51:18', '2020-09-18 15:51:18'),
	(2, 6, 80.00, 'jangan mau kalah oleh teman', '2020-09-18 15:51:18', '2020-09-18 15:51:18'),
	(2, 13, 75.00, 'kurang sekali performanya', '2020-09-18 15:51:18', '2020-09-18 15:51:18'),
	(2, 17, 78.50, 'lumayan', '2020-09-18 15:51:18', '2020-09-18 15:51:18'),
	(3, 1, 90.00, '', '2020-09-18 16:50:16', '2020-09-18 16:50:28'),
	(3, 6, 90.00, '', '2020-09-18 16:50:28', '2020-09-18 16:50:28'),
	(3, 13, 90.00, '', '2020-09-18 16:50:28', '2020-09-18 16:50:28'),
	(3, 17, 80.00, '', '2020-09-18 16:50:28', '2020-09-18 16:50:28'),
	(3, 18, 90.00, '', '2020-09-18 16:50:28', '2020-09-18 16:50:36'),
	(3, 31, 90.00, '', '2020-09-18 16:50:28', '2020-09-18 16:50:28'),
	(3, 32, 90.00, '', '2020-09-18 16:50:28', '2020-09-18 16:50:28');
/*!40000 ALTER TABLE `tb_score_student` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_staff
...
-- Dumping data for table db_actudent.tb_staff: ~10 rows (approximately)
...
-- Dumping data for table db_actudent.tb_student: ~33 rows (approximately)
/*!40000 ALTER TABLE `tb_student` DISABLE KEYS */;
INSERT INTO `tb_student` (`student_id`, `student_nis`, `student_name`, `student_tag`, `deleted`, `created`, `modified`) VALUES
	(1, '2015420022', 'Adnan Zaki', 2, 0, '2018-10-20 11:19:34', '2020-02-19 21:08:16'),
	(2, '2015420003', 'Saka Putra ', 3, 1, '2018-10-20 10:23:30', '2020-02-19 22:34:07'),
	(3, '2015420004', 'Bima Sakti', 2, 0, '2018-10-14 10:02:10', '2020-02-19 21:15:04'),
	(4, '2015420015', 'Widya Sari Wangi', 3, 1, '2018-10-19 16:32:46', '2020-02-19 22:34:06'),
	(5, '2015420049', 'Joko Tole', 1, 1, '2020-02-10 10:58:02', '2020-02-17 12:41:48'),
	(6, '2014310039', 'Dani Rusmawan', 1, 0, '2018-10-20 10:11:18', '2020-02-22 21:46:11'),
	(7, '2014310012', 'Mukhlisin', 1, 0, '2018-10-20 10:11:23', '2018-10-20 00:00:00'),
	(8, '2015310028', 'Rino Ardiansyah', 1, 0, '2018-10-20 11:20:22', '2018-10-20 00:00:00'),
	(9, '2015310029', 'Raju Herningtyas Pratama', 1, 0, '2018-10-20 10:11:44', '2018-10-20 00:00:00'),
	(10, '2014310088', 'Ridwan Kamil', 1, 0, '2018-10-20 10:11:48', '2018-10-20 00:00:00'),
	(11, '2015310098', 'Firhan Yudha Gamalama', 2, 0, '2018-10-20 20:53:06', '2020-02-22 21:46:54'),
	(12, '2014220038', 'Try Albahri', 1, 0, '2018-10-20 20:53:06', '2018-10-20 00:00:00'),
	(13, '2015190029', 'Wahyudi', 1, 0, '2018-10-20 20:53:06', '2018-10-20 00:00:00'),
	(14, '2015310124', 'Kipiir', 1, 0, '2018-11-13 23:53:15', '2020-02-10 23:05:45'),
	(17, '2837893745', 'Dennis Septianto', 1, 0, '2020-02-18 14:45:41', '2020-02-18 14:45:41'),
	(18, '192009008', 'Johnson Saputra', 1, 0, '2020-02-19 11:57:03', '2020-02-19 11:57:03'),
	(19, '2082390840', 'Sari Koala', 3, 1, '2020-02-19 21:13:09', '2020-02-19 22:32:54'),
	(20, '2003949343', 'Indra Herlambang', 3, 1, '2020-02-19 21:14:45', '2020-02-19 22:34:07'),
	(21, '3098230984', 'Johnson Simatupang', 1, 0, '2020-02-19 21:15:36', '2020-02-19 21:15:36'),
	(23, '209230493', 'Jenong Pampang', 3, 1, '2020-02-20 11:21:08', '2020-02-20 11:21:37'),
	(24, '1920092093', 'Rian Nurdoni', 1, 0, '2020-03-10 14:35:22', '2020-03-10 14:35:22'),
	(25, '1920392890', 'Edwin Zigot', 3, 1, '2020-03-10 14:35:49', '2020-03-11 22:43:42'),
	(26, '1928023009', 'Doni Kusumadewi', 1, 0, '2020-03-10 14:36:07', '2020-03-10 14:36:07'),
	(27, '1920209189', 'Brendon Rodgers', 1, 0, '2020-03-11 20:06:36', '2020-03-11 20:06:36'),
	(28, '1819098198', 'Badrun Simalakama', 1, 0, '2020-03-11 20:06:52', '2020-03-11 20:06:52'),
	(29, '1920292038', 'Soleh Nur Majid', 1, 0, '2020-03-11 20:09:27', '2020-03-11 20:09:27'),
	(30, '1920908239', 'Rian Sanjaya', 1, 0, '2020-03-11 22:44:20', '2020-03-11 22:44:20'),
	(31, '1920093489', 'Taufik Silobahutang', 1, 0, '2020-03-11 22:44:36', '2020-03-11 22:44:36'),
	(32, '1920923890', 'Roni Hidayat', 1, 0, '2020-03-11 22:44:53', '2020-03-11 22:44:53'),
	(33, '2392830918', 'Sinta Nurlia', 3, 1, '2020-04-03 20:07:18', '2020-04-03 20:07:32'),
	(34, '9028394893', 'Raihan Nur Fajri', 1, 0, '2020-07-09 12:39:22', '2020-07-09 12:39:22'),
	(35, '1209890328', 'Lala Sintia', 1, 0, '2020-07-09 12:39:44', '2020-07-09 12:39:44'),
	(36, '1290809238', 'Indah Purnamasari', 1, 0, '2020-07-09 12:40:18', '2020-07-09 12:40:18');
/*!40000 ALTER TABLE `tb_student` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_student_grade
...
-- Dumping data for table db_actudent.tb_student_grade: ~26 rows (approximately)
...
INSERT INTO `tb_student_grade` (`student_id`, `grade_id`, `student_tag`, `deleted`, `created`, `modified`) VALUES
	(1, 2, 1, 0, '2020-03-11 22:45:20', '2020-03-11 22:45:20'),
	(3, 6, 1, 0, '2020-03-11 22:27:58', '2020-03-11 22:27:58'),
	(6, 2, 1, 0, '2020-03-11 16:31:05', '2020-03-11 16:31:05'),
	(7, 3, 1, 0, '2020-03-11 20:09:58', '2020-03-11 20:09:58'),
	(8, 6, 1, 0, '2022-03-03 13:53:58', '2022-03-03 13:53:58'),
	(9, 3, 1, 0, '2020-03-11 20:10:18', '2020-03-11 20:10:18'),
	(10, 3, 1, 0, '2020-03-12 10:03:47', '2020-03-12 10:03:47'),
	(11, 6, 1, 0, '2020-03-11 22:28:00', '2020-03-11 22:28:00'),
	(12, 3, 1, 0, '2020-03-11 20:10:16', '2020-03-11 20:10:16'),
	(13, 2, 1, 0, '2020-03-12 10:03:41', '2020-03-12 10:03:41'),
	(14, 6, 1, 0, '2020-03-20 08:51:14', '2020-03-20 08:51:14'),
	(17, 2, 1, 0, '2020-03-11 16:31:02', '2020-03-11 16:31:02'),
	(18, 2, 1, 0, '2020-03-11 22:45:23', '2020-03-11 22:45:23'),
	(21, 3, 1, 0, '2020-03-11 20:10:00', '2020-03-11 20:10:00'),
	(24, 6, 1, 0, '2020-03-11 22:28:02', '2020-03-11 22:28:02'),
	(25, 6, 3, 1, '2020-03-11 22:22:16', '2020-04-03 17:51:01'),
	(26, 6, 1, 0, '2020-03-12 10:03:30', '2020-03-12 10:03:30'),
	(27, 3, 1, 0, '2020-03-11 20:10:20', '2020-03-11 20:10:20'),
	(28, 6, 1, 0, '2020-03-11 22:22:14', '2020-03-11 22:22:14'),
	(29, 3, 1, 0, '2020-03-11 20:10:17', '2020-03-11 20:10:17'),
	(30, 3, 1, 0, '2020-03-12 10:03:49', '2020-03-12 10:03:49'),
	(31, 2, 1, 0, '2020-03-12 10:03:42', '2020-03-12 10:03:42'),
	(32, 2, 1, 0, '2020-03-11 22:45:25', '2020-03-11 22:45:25'),
	(34, 3, 1, 0, '2020-07-09 12:40:59', '2020-07-09 12:40:59'),
	(35, 6, 1, 0, '2020-07-09 12:40:43', '2020-07-09 12:40:43'),
	(36, 2, 1, 0, '2020-07-09 12:40:51', '2020-07-09 12:40:51');
/*!40000 ALTER TABLE `tb_student_grade` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_student_parent
...
-- Dumping data for table db_actudent.tb_student_parent: ~32 rows (approximately)
/*!40000 ALTER TABLE `tb_student_parent` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_student_parent` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_timeline_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_timeline_comments` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `tb_timeline_likes` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_timeline_likes` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_timelog
...
-- Dumping data for table db_actudent.tb_timelog: ~2 rows (approximately)
...
INSERT INTO `tb_timelog` (`log_id`, `student_nis`, `verifymode`, `timestamp`, `iomode`, `created`) VALUES
	(1, '2015420022', 1, '2020-04-23 21:34:06', 1, '2020-04-23 23:42:09'),
	(2, '1920209189', 1, '2020-04-20 21:34:06', 1, '2020-04-23 23:42:09');
/*!40000 ALTER TABLE `tb_timelog` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_user
...
-- Dumping data for table db_actudent.tb_user: ~56 rows (approximately)
/*!40000 ALTER TABLE `tb_user` DISABLE KEYS */;
INSERT INTO `tb_user` (`user_id`, `user_name`, `user_email`, `user_password`, `user_level`, `deleted`, `network`, `created`, `modified`) VALUES
	(1, 'Adnan Zaki', 'admin@localhost', '$2y$10$gKk1sx1Jx/cXx2L8BolU4emqDn2Kg/zSr9hqOb7Syo5NpisY.QnwC', 1, 0, 'online', '2018-10-11 00:00:00', '2021-04-04 23:39:11'),
	(2, 'Mukhlisin', 'mukliz@wolestech.com', '$2y$10$8n/ojdr/Cb6DjfBIjVKkvekVHXfjXAATlWlnsMZAvV9ioz7Zv/La2', 0, 0, 'offline', '2018-10-31 00:00:00', '2020-06-17 14:20:50'),
	(3, 'Dany Prastio', 'danyprastio@wolestech.com', '$2y$10$UpUUj08e6BuSfzOWqUJvQ.Y6ue8CCO/98RKshSx3hJL7OF5tkrpUe', 0, 0, 'offline', '2018-10-31 00:00:00', '2020-06-17 14:20:50'),
	(4, 'Firhan Yudha P.', 'firhanyp@localhost', '$2y$10$ZNHsoY2tCHDwpHQwS6PGAuVRNVp3WHR0leTZQGnioFm33cS7.pD/S', 2, 0, 'online', '2019-03-18 00:00:00', '2022-05-24 23:01:38'),
	(12, 'Uus Rusmawan Prasetyo', 'uusrusmawan@smkn11kotabekasi.actudent.com', '$2y$10$TQiPrPCdBHcu9lkcfOTy7eFMmSCrRFmcgNBRjw8viXo2EVyvKxdd2', 0, 0, 'offline', '2019-03-28 00:00:00', '2020-06-17 14:20:50'),
	(13, 'Sudrajat', 'sudrajat@demo.actudent.com', '$2y$10$uRTcEtv.NxzipbhTI5mXPOrC7mWw4j7MSOJ5up8gztVR/YqZ.cg5a', 2, 0, 'online', '2019-03-29 00:00:00', '2020-07-10 13:17:32'),
	(14, 'Bambang Tri', 'bambang@smkn11kotabekasi.actudent.com', '$2y$10$3qsfIV6tYUkZvCgs6uTu6.X4lnZnLP2.ZVDixeL/Obk0cuRlt0o1S', 0, 1, 'offline', '2020-02-08 12:04:31', '2020-06-17 14:20:50'),
	(15, 'Sinto', 'sinto@smkn11kotabekasi.actudent.com', '$2y$10$ZUfIX77V.H8HZYsENgFoH.QhdH8jBpDrzKb3UXCb/yQISzuxTfnvy', 0, 1, 'offline', '2020-02-08 12:06:12', '2020-06-17 14:20:50'),
	(16, 'Rizky Nur Hidayat', 'rizkynur@smkn11kotabekasi.actudent.com', '$2y$10$FQnHnmSSTgW6mUYb8B/Lxer3ltbmcBuijIrY4qQr4szfM063heMyC', 0, 1, 'offline', '2020-02-10 09:54:50', '2020-06-17 14:20:50'),
	(17, 'Bernard Siahaan', 'bernard@smkn11kotabekasi.actudent.com', '$2y$10$4aBQchBOsJmjj5FSi4q3vOtp1oC4gaoz9FrobyyjgeIagp3SKY9Hy', 0, 1, 'offline', '2020-02-10 10:01:31', '2020-06-17 14:20:50'),
	(23, 'Susanto Nurjaman', 'susantonur@smkn11kotabekasi.actudent.com', '$2y$10$OPDJcB9JSaS8m9KnqJbFHOMkC//xz6o69WOTzAIHqyOtZ63/6KE1u', 0, 0, 'offline', '2020-02-10 14:33:09', '2020-06-17 14:20:50'),
	(24, 'Ahmad Ridho', 'ahmad.ridho@smkn11kotabekasi.actudent.com', '$2y$10$tiSdWeWFn9.l6KR.JQzkw.G6AEXJtQjwMz7otMwc8zUFwQt49EK/e', 0, 0, 'offline', '2020-02-10 14:34:15', '2020-06-17 14:20:50'),
	(25, 'Fahruliansyah', 'fahruliansyah@smkn11kotabekasi.actudent.com', '$2y$10$sHnfCCQmtA1CCsGH5V/v7u5bjbDMhYJcGQ2rhGKeL2Y0mX8YmkkHO', 0, 0, 'offline', '2020-02-10 14:35:17', '2020-06-17 14:20:50'),
	(26, 'Andreas Prasetyo', 'andreas.prasetya@smkn11kotabekasi.actudent.com', '$2y$10$f2Vf06NLCbTYGLO2opRWlOcxTsnlRPVpY0dQxeMUwmfYv1ooiiNk2', 0, 0, 'offline', '2020-02-10 14:35:53', '2020-06-17 14:20:50'),
	(27, 'Emet Nur Cholis', 'emet.cholis@smkn11kotabekasi.actudent.com', '$2y$10$xeeenDsJ1.U3UaGAXarBWOf2GhtbdXnApe9G9aPfqvfHUlYW1p4Me', 0, 0, 'offline', '2020-02-10 14:38:11', '2020-06-17 14:20:50'),
	(28, 'Gledek Nurmantyo', 'gledek.nur@smkn11kotabekasi.actudent.com', '$2y$10$VuBTeKY26z1.ZD7bigwanuBwZawaabZ4nO3/MiOPpWoEQTvbLC0Gi', 0, 0, 'offline', '2020-02-10 15:10:10', '2020-06-17 14:20:50'),
	(29, 'asdgvfevbds', 'asdgvfevbds@smkn11kotabekasi.actudent.com', '$2y$10$m6dhzqnTeTeHSapp7ncDweLxGsmCk4cpCVjtMS22XGJx72KMXpG9W', 0, 0, 'offline', '2020-02-10 15:15:03', '2020-06-17 14:20:50'),
	(30, 'Badut Siahaan', 'badut.siahaan@demo.actudent.com', '$2y$10$uRTcEtv.NxzipbhTI5mXPOrC7mWw4j7MSOJ5up8gztVR/YqZ.cg5a', 3, 0, 'offline', '2020-02-10 15:16:45', '2020-06-30 15:58:58'),
	(31, 'Katmo', 'yuhu@smkn11kotabekasi.actudent.com', '$2y$10$QCZkcT17AjFTDqsMEk5B.OyPaplWSv5JmiN/LfOvH7Doi9hFBjdyu', 0, 0, 'offline', '2020-02-10 15:16:56', '2020-06-17 14:20:50'),
	(32, 'Abdi Negara', 'abdinegara@smkn11kotabekasi.actudent.com', '$2y$10$1Lt/0LZQ5UxQxG.QSYJCc.8DKqfiLbIMtpvIfxa/02jiseyS1LmG6', 0, 0, 'offline', '2020-02-10 15:17:14', '2020-06-17 14:20:50'),
	(33, 'Yono', 'ahay@smkn11kotabekasi.actudent.com', '$2y$10$fiKYu1o07/j5vAGRdjsbWugXl5msV3KBmh2.3YjP8xGxeDQmsgR4u', 0, 0, 'offline', '2020-02-10 15:17:33', '2020-06-17 14:20:50'),
	(34, 'Amran Kartakarun', 'lelejepang@smkn11kotabekasi.actudent.com', '$2y$10$519EUkbcNvfhUDCnMWmU0.gGVBIxTlpvABpYfAbyVjsoaxLUq21GC', 0, 0, 'offline', '2020-02-10 15:17:53', '2020-06-17 14:20:50'),
	(35, 'Jajang', 'bedul@smkn11kotabekasi.actudent.com', '$2y$10$VgvRgehTFqw.zT18.WhFneNCRTH6UAh8qosqAMqQQC9qEGBOZUmne', 0, 0, 'offline', '2020-02-10 15:18:10', '2020-06-17 14:20:50'),
	(36, 'Sandrayono', 'didikempot@smkn11kotabekasi.actudent.com', '$2y$10$aJ2zsiCmT9vEkp2XeyK1WuVVG4ielaNRMK2C9BTCB/m3UMjl/zxSe', 0, 0, 'offline', '2020-02-10 15:19:23', '2020-06-17 14:20:50'),
	(37, 'Anto', 'cekot@smkn11kotabekasi.actudent.com', '$2y$10$Gx4MOrOMnQUf5vUm3SjhXe8RDILcDHjctiEZ6zZxUb6y9GqCPjsZK', 0, 0, 'offline', '2020-02-10 15:19:31', '2020-06-17 14:20:50'),
	(38, 'dgjhrsjthj', 'ihi@smkn11kotabekasi.actudent.com', '$2y$10$xSKCnhM0Puv6Ws4.9/lQxuykJf0NLUCRosZHnSNzDBB4ihZ5mvsMa', 0, 0, 'offline', '2020-02-10 15:20:15', '2020-06-17 14:20:50'),
	(39, 'Mugiono Apriyani', 'mugiono.apriyani@smkn11kotabekasi.actudent.com', '$2y$10$FSiwxDs87YTx2k44TpACr.DVlvtjQyyAgNApefDpWuer4CC5Dz0Hu', 0, 0, 'offline', '2020-02-10 15:31:25', '2020-06-17 14:20:50'),
	(40, 'Linda Sukmawati', 'linda.sukma@smkn11kotabekasi.actudent.com', '$2y$10$RzAC35rNJShVZjB8EYZYoe9UVwu/oGOgZF4XaSu1XgynBlOhpGiZW', 0, 1, 'offline', '2020-02-20 11:25:09', '2020-06-17 14:20:50'),
	(41, 'Berry Sihalahua', 'berry.sihala@smkn11kotabekasi.actudent.com', '$2y$10$3p8fGp7UrvUBQgb8eIN9E.rb9DuS0Rco2AFzRdyc1acXFS/b9LRq.', 0, 0, 'offline', '2020-03-10 14:32:22', '2020-06-17 14:20:50'),
	(42, 'Abdul Jabbar', 'abduljabbar@smkn11kotabekasi.actudent.com', '$2y$10$GxMQ9W8Oh/urNJteKMQB8uA/lpoSAouTZE4p7xF/F4BFej7BWytl2', 0, 0, 'offline', '2020-03-10 14:34:54', '2020-06-17 14:20:50'),
	(43, 'Riko Tantorini', 'rikotanto@smkn11kotabekasi.actudent.com', '$2y$10$MQ8K72/H/xm0l1LCHDXYRuQerQYknJMynU6Dr37Pkl/IuywjVyktS', 0, 0, 'offline', '2020-03-11 20:09:01', '2020-06-17 14:20:50'),
	(44, 'Rian Mangkulangit', 'rianmangkulangit@smkn11kotabekasi.actudent.com', '$2y$10$KfyKWSudFaaSQVxByz3jzubP0VQC54lu/njLp3ezC/DXg9oqbUYhG', 0, 0, 'offline', '2020-03-13 07:11:26', '2020-06-17 14:20:50'),
	(45, 'Reinhard Oktora', 'reinhard.oktora@smkn11kotabekasi.actudent.com', '$2y$10$Vvnfh0n5jC29K2U3k90h0unCWwc7Sm8jIxo1NKycYe016EctK3cSe', 0, 0, 'offline', '2020-03-13 07:12:31', '2020-06-17 14:20:50'),
	(46, 'Baharudin Saifulloh', 'baharsaiful@smkn11kotabekasi.actudent.com', '$2y$10$fmGet4t.IjLkL3.8KgJvpuaMPfwqFKGE.ZEw6A2XCnX2gaN3aqgMi', 0, 1, 'offline', '2020-04-03 20:06:55', '2020-06-17 14:20:50'),
	(47, 'Indah Dwi Hartati', 'indahhartati@smkn11kotabekasi.actudent.com', '$2y$10$KKPF1a.COnWa4.6HLI4GWutggcWTNFImmFX.ufjXv3UWtnCKl.GHS', 0, 0, 'offline', '2020-04-06 08:39:35', '2020-06-17 14:20:50'),
	(48, 'Lintang Sudarmanto', 'lintangsudarmanto@smkn11kotabekasi.actudent.com', '$2y$10$K7LrXPpLuRs/a8cJjr0muOAz4fht.aeuvJspz2g1v9gCVIsAsq11u', 0, 0, 'offline', '2020-04-06 08:40:30', '2020-06-17 14:20:50'),
	(49, 'Abdal Salem', 'abdalsalem@smkn11kotabekasi.actudent.com', '$2y$10$ZdISGSPBBg7k2LjZnLFsJOjhrYiQvM3QdWftzQNj/h.HyALFrJHD.', 0, 0, 'offline', '2020-04-06 08:43:50', '2020-06-17 14:20:50'),
	(50, 'Edwin Susanto', 'edwin.susanto@smkn11kotabekasi.actudent.com', '$2y$10$U7FyAdvPZnarAk0molJo2uAZmIlv63vzjdrbZy9Skv8se.bAOfQ2e', 0, 0, 'offline', '2020-04-17 17:12:26', '2020-06-17 14:20:50'),
	(51, 'Indri Sintiasari', 'indrisintia@smkn999kotabekasi.actudent.com', '$2y$10$rAUBYcBeGxkhSW2D3lfF.OiNQv2fUbd.tSCygzAYmaFb4albHylAi', 3, 0, 'offline', '2020-07-09 12:36:01', '2020-07-09 12:36:01'),
	(52, 'Kartono', 'kartono99@smkn999kotabekasi.actudent.com', '$2y$10$xJ7jc.uJFjrkBagIWzhE5OeUsH5ScATBmt.r5JQ6E9rb4lu5qjHae', 3, 0, 'offline', '2020-07-09 12:37:39', '2020-07-09 12:37:39'),
	(53, 'Muhammad Rizal', 'mrizal@localhost', '$2y$10$VV1nFPRnYpvAUkgvI9PcGOj/aGvqcxAFyyX3UvdVCoJC4lotKnoDW', 2, 0, 'online', '2020-07-10 12:47:57', '2022-05-24 23:02:27'),
	(54, 'Administrator', 'admin@demo.actudent.com', '$2y$10$gKk1sx1Jx/cXx2L8BolU4emqDn2Kg/zSr9hqOb7Syo5NpisY.QnwC', 1, 0, 'online', '2021-02-03 09:45:55', '2021-03-15 13:40:13'),
	(55, 'Abdul Majid', 'abdulmajid97@demo.actudent.com', '$2y$10$HzH7jhmpnhT4/GFjT76ZieUO2VF3joByaXh1bdUMIR04it2wDgaPe', 3, 0, 'offline', '2021-05-17 11:29:42', '2021-05-17 11:29:42'),
	(56, 'jsndfjsn', 'kjnjfnfj@demo.actudent.com', '$2y$10$I1YR8I.lA1DqE33igLMKZOOmRaETKcvNE9MWVSupo9n2Js4aKX0OG', 3, 0, 'offline', '2021-05-17 15:06:27', '2021-05-17 15:06:27'),
	(57, 'Ibnu Kamil', 'ibnukamil87@demo.actudent.com', '$2y$10$ZWMk7ceGzAWmmSvP6usSjuUOpqdrHSZEhV0s.xHryn25ZWmXV1/p6', 3, 0, 'offline', '2021-05-17 15:28:06', '2021-05-17 15:28:06'),
	(58, 'Ahmad Hasan ', 'rinapuspita@demo.actudent.com', '$2y$10$M7nn0bSfzdNeWGX8CQU7HOaBCej3f8TZbqg80P1PzqAe/AVP0x2dq', 3, 0, 'offline', '2021-05-17 15:30:35', '2021-05-17 15:30:35'),
	(59, 'Ahmad Fajrul', 'rinarosinta@demo.actudent.com', '$2y$10$rlLUPusxbvy2apBACoZESeopwNw4VAPSJ4SUk78mUOs.r2Up2h5i6', 3, 0, 'offline', '2021-05-17 15:31:31', '2021-05-17 15:31:31'),
	(60, 'Rima Nurmala', 'rimanurmala@demo.actudent.com', '$2y$10$wVX5tG1g.54Az.Crlhafpe.WGqn8LriawV8ZuAmMEJ77H4vCWsKQa', 3, 0, 'offline', '2021-05-17 17:28:06', '2021-05-17 17:28:06'),
	(61, 'Adi Sumarno', 'adi_sumarno@demo.actudent.com', '$2y$10$VLnn68bLggBLVPnZN0T69O/iHH0Tj6NuMA9L80MyFiH8jhmLaTt3y', 3, 0, 'offline', '2021-05-17 17:44:07', '2021-05-17 17:44:07'),
	(62, 'Hamdan Syakirin', 'hamdans@demo.actudent.com', '$2y$10$hn1XSqIpxicTxlOznrNIv.UQ9ODXxwh09otNbLZKGBPM/l/rGILF2', 3, 0, 'offline', '2021-05-17 17:48:17', '2021-05-17 17:48:17'),
	(63, 'Hamdan Naimin', 'hamdanna@demo.actudent.com', '$2y$10$dweEpb382S4Y6V.uVi5XYOcvEUYDnlpheqPpNmcU1DTWgmwD6FF9m', 3, 0, 'offline', '2021-05-17 17:57:22', '2021-05-17 17:57:22'),
	(64, 'Syarif Romadhon', 'syarif_r192@demo.actudent.com', '$2y$10$8kS86VVcEX8dp9qYJolqNuO18GWOD7dFsgLoVHYqAe4L2A99//Zmu', 3, 0, 'offline', '2021-05-17 19:56:31', '2021-05-17 19:56:31'),
	(65, 'Izzatul Islam', 'izzatul_islam@demo.actudent.com', '$2y$10$OXaD.DmIdONG/9LvqCaaP.yHDvZbSuHF6I7zMLcDJPyhMBP9O5biO', 3, 0, 'offline', '2021-05-17 20:04:32', '2021-05-17 20:04:32'),
	(66, 'Abdul Fattah', 'abdulfattah@demo.actudent.com', '$2y$10$a8UdokSBwOoIGUdrkTHhkODvY9p3Qw208zyDE3fcW1Tue/6uFH.5q', 3, 0, 'offline', '2021-05-17 20:05:20', '2021-05-17 20:05:20'),
	(67, 'Himdin', 'himdin982@demo.actudent.com', '$2y$10$dCgnt6HfDhFtB.xor0sBqOfPPjlk7C/JArrPyAIeqI5.S/aETK0Ly', 3, 0, 'offline', '2021-05-17 20:09:31', '2021-05-17 20:09:31'),
	(68, 'Huntu', 'huntu92@demo.actudent.com', '$2y$10$9ldHEXaRC.nBLCaeUnUF0.eNDSrLfBtpicebe2sPQly/.Wc0YxFi.', 3, 0, 'offline', '2021-05-18 12:25:52', '2021-05-18 12:25:52');
/*!40000 ALTER TABLE `tb_user` ENABLE KEYS */;

-- Dumping structure for table db_actudent.tb_user_devices
...
-- Dumping data for table db_actudent.tb_user_devices: ~3 rows (approximately)
/*!40000 ALTER TABLE `tb_user_devices` DISABLE KEYS */;
INSERT INTO `tb_user_devices` (`device_id`, `user_id`, `device_type`, `device_version`, `fcm_registration_id`, `status`, `created`, `modified`) VALUES
	(1, 30, 'ANDROID', '24', 'ePCVe_8USAeZ3yUNvdp1RK:APA91bHRFNlwF1BfnC2Z0o4LFLzdYTEWEZ-oj332vbPWdEzaIbaZnId-bw-R7YQeok5aBl8oETGdrohxGZUPwk8V6PTm5vmhJGuhCZgSE8mtHpxvNygnex72_7jt3gTllZkaaaIWfNFG', 1, '2020-06-30 15:59:03', '2020-11-13 12:59:06'),
	(2, 13, 'ANDROID', '22', 'c-YZKEFAQiyOw6clw_Te5V:APA91bHTXYu1VowS715yDVaP1X5tW1wJAQjrJIFdPEfKYGN0Cyw3WmWPaEIteTpCNV81ZNnO7tEy1mUFZSCk1WxPn-dLbdLVYQwfqm0yz8V3B7zN5-lYdKI-Q4icJWgr_idEnQjaVkdJ', 0, '2020-06-30 17:12:35', '2020-07-11 08:57:19'),
	(3, 53, 'ANDROID', '29', 'fcDzlt1TSZKGmb6WJPHmVf:APA91bHfyz4df_gdrbdsttsqbVYJwJrJnNEbfm0P2_zPxk7zQ0U0xo8y0D4Eds3vExnYc9M-RxOBNPmCr9UrtAht_X-lK6A79bYifto46E_dnUSd9wY489Ms7c9qkUMZz8y39UGt9QiT', 1, '2020-07-10 13:27:35', '2020-12-16 18:04:41');
/*!40000 ALTER TABLE `tb_user_devices` ENABLE KEYS */;
