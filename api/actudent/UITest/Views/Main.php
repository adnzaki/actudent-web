...
<head>
	...
	<link rel=icon type=image/png sizes=128x128 href={ui}icons/favicon-128x128.png> 
	...
	<link rel=apple-touch-icon href={ui}icons/apple-icon-120x120.png> 
	<link rel=apple-touch-icon sizes=152x152 href={ui}icons/apple-icon-152x152.png> 
	<link rel=apple-touch-icon sizes=167x167 href={ui}icons/apple-icon-167x167.png>
	<link rel=apple-touch-icon sizes=180x180 href={ui}icons/apple-icon-180x180.png> 
	<link rel=mask-icon href={ui}icons/safari-pinned-tab.svg color=#027be3>
...
<body>
	<div id=q-app></div>
	<script src={ui}js/vendor.8c50f5b7.js> </script> <script src={ui}js/app.25cce8e3.js> </script>
</body> 
</html>