<table class="no-border">
    <tbody>
        <tr>
            <?php if($signSetting === 'kepsek,waka,walas'): ?>
            ...
            <?php elseif($signSetting === 'kepsek,walas'): ?>
            <td class="center-align no-border">
                Mengetahui, <br>Kepala Sekolah
                <p class="mt-80">
                    <strong><?= $kepalaSekolah ?></strong>
            ...
            <td class="center-align no-border"></td>
            <td class="center-align no-border">
                <br>Wali Kelas
                <p class="mt-80">
                    <strong><?= $grade->staff_name ?></strong>
            ...
            <?php else: ?>
            <td class="center-align no-border" width="200"></td>
            <td class="center-align no-border"></td>
            <td class="center-align no-border">
                <br><?= $lokasiSekolah . ', ' . $date ?>
                <br>Wali Kelas
                <p class="mt-80">
                    <strong><?= $grade->staff_name ?></strong>
