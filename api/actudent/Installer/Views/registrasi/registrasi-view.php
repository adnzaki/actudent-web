...
<body class="vertical-layout vertical-menu 2-columns {bodyColor} menu-expanded fixed-navbar" data-open="click"
	...
	<div class="app-content content install-content">
		<div class="content-wrapper">
			...
			<div class="content-body" id="register-content">
				<div class="row">
					<div class="col-12">
						<div class="card {cardColor}">
							<div class="card-header {cardColor}">
								<h4 class="card-title {cardTitleColor}">{+ lang Registration.register_title +}</h4>
							...
							<!-- {+ include Actudent\Installer\Views\registrasi\FormSekolah +} -->
						</div>
					</div>
				</div>
			</div>
	...
	<script src="{assets}js/install/registrasi.js" type="module"></script>
	<!-- END PAGE LEVEL JS-->
</body>
