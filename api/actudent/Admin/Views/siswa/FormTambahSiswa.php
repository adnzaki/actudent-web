				...
				<form class="form" id="formTambahSiswa">
					<div class="form-body">
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" minlength="9" maxlength="10"
								:placeholder="lang.siswa_nis" name="student_nis">
							<form-error :msg="error.student_nis" />
						</div>
						<div class="form-group">
							<label for="userinput6">{{ lang.siswa_nama }}</label>
							<input class="form-control border-primary" type="text" :placeholder="lang.siswa_input_nama"
								name="student_name">
