<!-- Modal -->
<div class="modal fade text-left" id="tambahKelasModal" role="dialog" aria-labelledby="myModalLabel2"
	aria-hidden="true">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header {modalHeaderColor} white">
				<h4 class="modal-title white" id="myModalLabel2"><i class="la la-road2"></i> {{ lang.kelas_add_title }}
				</h4>
			...
			<div class="modal-body">
				<form class="form" id="formTambahKelas">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<div class="input-group-append">
									<button class="btn btn-primary" type="button" @click="clearResult">{+ lang
										Admin.bersihkan +}</button>
								</div>
							</div>
							<div class="list-group list-group-custom add-margin-top-5px" v-if="searchResultWrapper">
								<a v-if="teachers.length === 0" href="javascript:void()" class="list-group-item list-group-item-action 
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" disabled type="text"
								:placeholder="lang.kelas_input_walikelas" v-model="selectedTeacher.name">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-danger" data-dismiss="modal"> {+ lang Admin.batal
					+}</button>
				<button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary"
					@click="save()"> {+ lang Admin.simpan +}</button>
			</div>
		</div>
	</div>
</div>
