		...
		<table>
			<thead class="grey-shading">
				<tr style="text-transform: capitalize;">
					...
					<th class="light-border center-align" colspan="5">Rekapitulasi</th>
				</tr>
				<tr>
			...
			<tbody>				
				...
				<tr>
					...
					<td class="center-align light-border "><?= $val['present'] ?></td>
					<td class="center-align light-border "><?= $val['permit'] ?></td>
					<td class="center-align light-border "><?= $val['sick'] ?></td>
					<td class="center-align light-border "><?= $val['absent'] ?></td>
