	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header {modalHeaderColor} white">
				<h4 class="modal-title white" id="myModalLabel2"><i class="la la-road2"></i> {{ lang.staff_form_add_title }}
				</h4>
				...
				<form id="formTambahPegawai">
					<div class="form-body skin skin-square">
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" minlength="10" maxlength="10"
								:placeholder="lang.staff_input_id" name="staff_nik">
							<form-error :msg="error.staff_nik" />
						</div>
						<div class="form-group">
							<label for="userinput5">{{ lang.staff_label_nama }}</label>
							<input class="form-control border-primary" type="text" :placeholder="lang.staff_input_nama"
								name="staff_name">
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" minlength="11" maxlength="13"
								:placeholder="lang.staff_input_telp" name="staff_phone">
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" :placeholder="lang.staff_input_jabatan"
								name="staff_title">
