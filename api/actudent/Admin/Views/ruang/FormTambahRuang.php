					...
					<div class="form-body skin skin-square">
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" minlength="3" maxlength="6"
								:placeholder="lang.ruang_input_kode" name="room_code">
							<form-error :msg="error.room_code" />
						</div>

						<div class="form-group">
							<label for="userinput6">{{ lang.ruang_nama }}</label>
							<input class="form-control border-primary" type="text" :placeholder="lang.ruang_input_nama"
								name="room_name">
