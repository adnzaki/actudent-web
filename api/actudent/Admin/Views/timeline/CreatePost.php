<div class="modal fade text-left" id="addPostModal" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
	<!-- Error message -->
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="formTambahPost">
					...
					<div class="form-group">
						...
						<textarea rows="6" name="timeline_content" class="form-control border-primary"
			...
			<div class="modal-footer">
				...
				<button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary"
					@click="save('draft')"> {{ lang.timeline_save_as_draft }}</button>
				<button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-success" @click="save()">
					{{ lang.timeline_publish }}</button>
			</div>
		</div>
	</div>
