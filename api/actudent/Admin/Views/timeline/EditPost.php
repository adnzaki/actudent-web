<div class="modal fade text-left" id="editPostModal" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
	<!-- Error message -->
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header {modalHeaderColor} white">
				<h4 class="modal-title white" id="myModalLabel2"><i class="la la-road2"></i> {{ lang.timeline_add_post_title }}
				</h4>
			...
			<div class="modal-body">
				<form id="formEditPost">
					...
					<div class="form-group">
						...
						<textarea rows="6" name="timeline_content" v-model="timelineDetail.timeline_content"
							class="form-control border-primary" placeholder="{+ lang AdminTimeline.timeline_input_content +}">
                        </textarea><br>
				...
				<div class="form-group">
					...
					<form name="upload-file" id="update-file" method="post" enctype="multipart/form-data">
						...
						<p class="text-bold success-text" v-if="helper.uploadProgress">{+ lang
							AdminTimeline.timeline_upload_progress +}</p>
			...
			<div class="modal-footer">
				...
				<button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary"
					@click="save('draft', timelineDetail.timeline_id)"> {{ lang.timeline_save_as_draft }}</button>
				<button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-success"
					@click="save('public', timelineDetail.timeline_id)"> {{ lang.timeline_publish }}</button>
			</div>
		</div>
	</div>
