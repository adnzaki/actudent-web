<!-- Modal -->
<div class="modal fade text-left" id="editNilaiModal" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
	<!-- Error message -->
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" :disabled="helper.disableSaveButton" class="btn btn-outline-primary"
					@click="save(true, scoreDetail.score_id)"> {+ lang Admin.simpan +}</button>
			</div>
		</div>
	</div>
</div>
