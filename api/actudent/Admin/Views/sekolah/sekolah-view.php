...
<body class="vertical-layout vertical-menu 2-columns {bodyColor} menu-expanded fixed-navbar" data-open="click"
	...
	<div class="app-content content">
		<div class="content-wrapper">
			...
			<div class="content-body" id="sekolah-content">
				{+ include Actudent\Admin\Views\dashboard\ExpirationWarning +} 
				<div class="row">
					<div class="col-12">
						<div class="card {cardColor}">
							<div class="card-header {cardColor}">
								<h4 class="card-title {cardTitleColor}">{+ lang Sekolah.title +}</h4>
							...
							{+ include Actudent\Admin\Views\sekolah\DataSekolah +}
							{+ include Actudent\Admin\Views\sekolah\FormEditSekolah +}
						</div>
					</div>
				</div>
			</div>
	...
	<script src="{assets}js/admin/ac-sekolah.js" type="module"></script>
	<!-- END PAGE LEVEL JS-->
</body>
