<!-- Success message -->
<alert-msg alert-class="bg-success" header="{+ lang Admin.sukses +}" :text="lang.agenda_insert_success"
	v-if="alert.show">
</alert-msg>
<!-- Start modal form -->
<div class="modal fade text-left" id="agendaModal" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
	<!-- Error message -->
				...
				<form class="form" id="formTambahAgenda" enctype="multipart/form-data">
					<div class="form-body">
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" :placeholder="lang.agenda_input_nama"
								name="agenda_name">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input type='text' name="timestart" :disabled="helper.fullDayEvent"
											:class="['form-control border-primary pickatime-add', timepickerStatus]"
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type='text' name="agendaDateEnd"
											class="form-control border-primary pickadate-selectors pickadate-add"
											:placeholder="lang.agenda_input_end" />
										<div class="input-group-append">
											<span class="input-group-text border-primary">
												<span class="la la-calendar-o"></span>
											</span>
						...
						<div class="form-group">
							...
							<textarea class="form-control border-primary" type="text" :placeholder="lang.agenda_input_desc"
								name="agenda_description"></textarea>
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" :placeholder="lang.agenda_input_loc"
						...
						<div class="form-group">
							...
							<div class="row add-margin-bottom-5px">
								<div class="col-12">
                                    ...
                                    cursor-pointer" v-for="tamu in guestToDisplay" :key="tamu.id">
										{{ tamu.name }} <strong @click="removeGuest(tamu)"><i
												class="la la-close font-medium-2"></i></strong>
									</div>
								</div>
							</div>
							...
							<div class="input-group">
								<input class="form-control border-primary" type="text" v-model="searchParam"
									@focus="searchResultWrapper = true" :placeholder="lang.agenda_input_guest" @keyup="searchGuest">
								<div class="input-group-append">
							...
							<div class="list-group list-group-custom add-margin-top-5px" v-if="searchResultWrapper">
								...
								<a href="javascript:void()" class="list-group-item list-group-item-action 
                                list-group-item-custom" v-for="guru in guests.wali_kelas" @click="pushGuest(guru)">
									{{ guru.text }}
								</a>
								<a href="javascript:void()" class="list-group-item active 
								...
								<a href="javascript:void()" class="list-group-item list-group-item-action 
                                list-group-item-custom" v-for="ortu in guests.wali_murid" @click="pushGuest(ortu)">
									{{ ortu.text }}
								</a>
							</div>
						</div>
