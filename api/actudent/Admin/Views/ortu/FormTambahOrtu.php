<!-- Modal -->
<div class="modal fade text-left" id="tambahOrtuModal" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
	<!-- Error message -->
				...
				<form class="form" id="formTambahOrtu">
					<div class="form-body skin skin-square">
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" minlength="16" maxlength="16"
								:placeholder="lang.ortu_input_kk" name="parent_family_card">
							<form-error :msg="error.parent_family_card" />
						</div>
						<div class="form-group">
							<label for="userinput6">{{ lang.ortu_label_ayah }}</label>
							<div class="input-group">
								<input class="form-control border-primary" type="text" v-model="fatherName"
									:placeholder="lang.ortu_input_ayah" name="parent_father_name">
								<div class="input-group-append">
									<button class="btn btn-outline-primary disable-hover" data-toggle="tooltip" data-placement="left"
										:title="lang.ortu_set_acc_name" type="button">
										<fieldset>
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input class="form-control border-primary" type="text" v-model="motherName"
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" type="text" minlength="11" maxlength="13"
								:placeholder="lang.ortu_input_telp" name="parent_phone_number">
							<form-error :msg="error.parent_phone_number" />
						</div>
						<div class="form-group">
							<label for="userinput6">{+ lang AdminUser.user_email +}</label>
							<div class="input-group">
								<input class="form-control border-primary" autocomplete="off" type="text" placeholder="username"
									name="user_email">
								<div class="input-group-append">
						...
						<div class="form-group">
							...
							<input class="form-control border-primary" type="password" name="user_password_confirm" minlength="8"
								placeholder="{+ lang AdminUser.user_pass_confirm +}">
